...
def main():
    ...
    label_names = [r'$\alpha$ = 0.1 , d = 0.01', r'$\alpha$ = 0.01 , d = 0.01', r'$\alpha$ = 0.001 , d = 0.001']
    parameter_name = 'holes_5'

    #evaluate_model('holes_5-repetition_5', 10000, True, True, False, False, True, True)

    compare_models(parameter_names=parameter_names, repetitions=20, show=True, savename='compare-lr-dc', label_names=label_names, smooth=True)

    #experiment(parameter_name=parameter_name, repetitions=20, n_samples=10000, print_strategies=True, print_evaluation=True)
