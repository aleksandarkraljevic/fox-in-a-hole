...
label_names = ['layers_1', 'layers_2', 'layers_3']
parameter_name = 'holes_9'

#evaluate_model('test', 10000, True, True, True, True, True)

#compare_models(parameter_names=parameter_names, repetitions=20, show=True, savename='compare-layers', label_names=label_names, smooth=True)
